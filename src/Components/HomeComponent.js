...
export default function Home(){
    return(
        <div className='container'>
            ...
            <Animate animateIn='animate__fadeInUp' animatePreScroll={false}  animateOnce={true}>
            <div className='contents'>
                ...
                <div className='inner-swap'>
                    <div className='inner-swap-content'>
                        ...
                        <Link to='/services/automation'>ai + rpa automation<span><img src='https://cdn1.iconfinder.com/data/icons/freeline/32/Arrow-Right-512.png'/></span></Link>
                    </div>
            ...
            <div className='contents'>
                ...
                <div className='inner-swap'>
                  <div className='inner-swap-content'>
                     ...
                     <Link to='/services/cloud-native'>Build Better App<span><img src='https://cdn1.iconfinder.com/data/icons/freeline/32/Arrow-Right-512.png'/></span></Link>
                  </div>
            ...
            <Animate animateIn='animate__fadeInUp' animateOnce={true}>
            <div className='contents'>
                <div className='inner-content'>   
                ...
                <div className='inner-swap'>
                  <div className='inner-swap-content'>
                     ...
                     <Link to='/services/devops'>DevOps<span><img src='https://cdn1.iconfinder.com/data/icons/freeline/32/Arrow-Right-512.png'/></span></Link>
                  </div>
            ...
            <div className='contents'>
                ...
                <div className='inner-swap'>
                  <div className='inner-swap-content'>
                     ...
                     <Link to='/services/cloud-transition'>cloud services<span><img src='https://cdn1.iconfinder.com/data/icons/freeline/32/Arrow-Right-512.png'/></span></Link>
                  </div>
